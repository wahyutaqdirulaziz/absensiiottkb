        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">
                        <a href="{{ route('user-create') }}" class="btn btn-primary"><i data-feather="plus"></i> Tambah Users</a>
                    </h5>
                </div>
                <div class="table-responsive">
                    <table class="table mb-0 table-striped table-hover datatables" id="datatables">
                        ...
                        @foreach ($data as $k)
                                <tr> 
                                    <td>{{ $no++ }}</td>
                                    <td><img class="img-fluid rounded-circle mb-2" src="https://png.pngtree.com/png-clipart/20190520/original/pngtree-vector-users-icon-png-image_4144740.jpg" width="60px" alt=""></td>
                                    <td>{{ $k->users->name }}</td>
                                    <td>{{ $k->users->email }}</td>
                                    <td>{{ $k->role->name }}</td>
                                    <td>
                                    @if ($k->role->name == 'user')
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ route('user-edit',$k->users->id) }}" class="btn btn-primary btn-sm" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 align-middle"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
